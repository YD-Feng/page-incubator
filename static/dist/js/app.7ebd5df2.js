...
var Vue = __webpack_require__(7),
    VueRouter = __webpack_require__(83),
    Vuex = __webpack_require__(85),
    VuexLogger = __webpack_require__(84),
    VueResource = __webpack_require__(82),
    ElementUI = __webpack_require__(81),
    VueBar = __webpack_require__(181),
...
window.router = new VueRouter({
    ...
    routes: __webpack_require__(179)
});
...
var store = new Vuex.Store({
    modules: {
        flags: __webpack_require__(180),
        dict: __webpack_require__(347)
    },
    strict: false,
...
Vue.prototype.$exportByForm = function (config) {
    ...
    if (config.data && (0, _typeof3.default)(config.data) == 'object') {
...
module.exports = [{
    ...
    component: function component(resolve) {
        __webpack_require__.e/* require.ensure */(2).then((function (require) {
            resolve(__webpack_require__(147));
    ...
    children: [{
        ...
        component: function component(resolve) {
            __webpack_require__.e/* require.ensure */(0).then((function (require) {
                resolve(__webpack_require__(145));
            }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
        } /*,
          {
    ...
    component: function component(resolve) {
        __webpack_require__.e/* require.ensure */(1).then((function (require) {
            resolve(__webpack_require__(146));
        }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
    }
}];
...
module.exports = {
    ...
    mutations: {
        triggerFlag: function triggerFlag(state) {
...
;(function () {
    ...
    var VueBar = {
        install: function install(Vue, options) {
            ...
            function initMutationObserver(el) {
                if ((typeof MutationObserver === 'undefined' ? 'undefined' : (0, _typeof3.default)(MutationObserver)) === (0, _typeof3.default)(void 0)) {
                    return null;
                }
    ...
    } else if ((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) !== (0, _typeof3.default)(void 0)) {
        window.VueBar = VueBar;
    }

    if ((typeof Vue === 'undefined' ? 'undefined' : (0, _typeof3.default)(Vue)) !== (0, _typeof3.default)(void 0)) {
        Vue.use(VueBar);
    }
})();
...
module.exports = {
    ...
    mutations: {
        setDict: function setDict(state, dict) {
            state.dict = dict;
        }
    }
};
